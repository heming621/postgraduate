...
object aprioriAlgm{
        ...
        def validateCdds(rawTrans:ArrayBuffer[Set[Int]], cdds:Set[Set[Int]], minCount:Int):Array[(Set[Int],Int)] = {
            rawTrans.flatMap(line => {
                ...
                for(cdd <- cdds){
                    tmp += cdd -> {if(cdd.subsetOf(line)) 1 else 0}//supOrNot(line, cdd)
                }
                tmp                                   
    ...
    def main(args: Array[String]){
        ...
        val DATA_PATH = "/home/mountDir/downloads/data/pumsb_star.dat"
        val minSup = 0.35
        ...
        val file = new File("/home/zhm/project03B/FIs.txt")
