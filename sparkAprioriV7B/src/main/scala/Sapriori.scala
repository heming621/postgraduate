...
object Sapriori{
    def main(args: Array[String]){
        ...
        val DATA_PATH = "hdfs://zhm01:9000/user/root/data/pumsb_star.dat"
        val minSup = 0.35
        ...
        val rawTrans = sc.textFile(DATA_PATH,20).map(_.split(" ").map(_.trim.toInt)).cache() // map: to each line; flatMap: to all lines 
        ...
        val file = new File("/home/zhm/sparkAprioriV7B/FIs.txt")
