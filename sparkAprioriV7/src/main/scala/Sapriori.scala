...
object Sapriori{
    def main(args: Array[String]){
        ...
        val DATA_PATH = "hdfs://zhm01:9000/user/root/data/mushroom.dat"
        val minSup = 0.15
        ...
        val rawTrans = sc.textFile(DATA_PATH,40).map(_.split(" ").map(_.trim.toInt)).cache() // map: to each line; flatMap: to all lines 
        ...
        val file = new File("/home/zhm/sparkAprioriV7/FIs.txt")
