...
object sEclat{
	...
	def main(args: Array[String]){
		...
		val LDATA_PATH = "/home/mountDir/downloads/data/pumsb_star.dat"//"/home/mountDir/downloads/data/mushroom.dat"
		val minSup = (0.25*49046).toInt//(0.1*8124).toInt
		...
		//// WRITE
        val fileName = new File("/home/zhm/sparkEclatV2/test.txt")
