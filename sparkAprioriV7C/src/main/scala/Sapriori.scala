...
object Sapriori{
    def main(args: Array[String]){
        ...
        val DATA_PATH = "hdfs://zhm01:9000/user/root/data/T40I10D100K.dat"
        val minSup = 0.14
        ...
        val rawTrans = sc.textFile(DATA_PATH,15).map(_.split(" ").map(_.trim.toInt)).cache() // map: to each line; flatMap: to all lines 
        ...
        val file = new File("/home/zhm/sparkAprioriV7C/FIs.txt")
